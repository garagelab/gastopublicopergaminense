...
from pergaminoweb.core import feeds
...
urlpatterns = patterns('',
                       url(r'^$',
                           'pergaminoweb.core.views.index',
                           {'start_date': datetime(datetime.now().year, 1, 1),
                            'end_date': datetime(datetime.now().year, 12, 31) },
                           name='index'),

                       url(r'^%s$' % mensual_expression,
                           'pergaminoweb.core.views.index_mensual',
                           name='index_mensual'),

                       url(r'^%s$' % anual_expression,
                           'pergaminoweb.core.views.index_anual',
                           name='index_anual'),

                       url(r'^%s$' % periodo_expression,
                           'pergaminoweb.core.views.index_periodo',
                           name='index_periodo'),

                       url(r'^ordenes-de-compra/$',
                           'pergaminoweb.core.views.index_ordenes',
                       ...
                       url(r'^need_help.html$',
                           'pergaminoweb.core.views.need_help',
                           name='need_help'),
